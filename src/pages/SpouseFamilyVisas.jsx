				...
				<div className="col-lg-12">
					<div className="breatcome-content text-center">
						<div className="breatcome-content-title">
							<h1>Spouse/Family Visas</h1>
						</div>
						<div className="breatcome-content-text">
							<ul>
								<li><a href="index.html">Home </a> <i className="fas fa-chevron-right"></i> <span>Spouse/Family Visas</span></li>
							</ul>
						</div>
					</div>
				</div>
...
export default SpouseFamilyVisas;
